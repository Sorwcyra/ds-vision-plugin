...
async function quickstart(configPath) {
	...
	console.log(portOverride === void 0 ? `Starting DeepSeek Harness on its default Web port (currently ${url})` : `Starting DeepSeek Harness at ${url}`);
	...
	if (portOverride !== void 0) dshArgs.push("--port", String(port));
